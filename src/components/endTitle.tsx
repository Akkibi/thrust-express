  ...
  return (
    <div className="absolute z-50 inset-0 bg-black/50 flex flex-col items-center justify-center">
      <div className="flex flex-col items-center justify-center">
        <div className="flex flex-col p-2 gap-3 bg-stone-700 rounded-2xl custom-light-border mb-50">
          <div className="flex flex-col p-3 gap-3 bg-stone-900 custom-inner-shadow rounded-xl items-center justify-center">
